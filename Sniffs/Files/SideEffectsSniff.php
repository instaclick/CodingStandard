<?php
/**
 * Instaclick_Sniffs_Files_SideEffectsSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Instaclick_Sniffs_Files_SideEffectsSniff extends PSR1_Sniffs_Files_SideEffectsSniff
{
    ...
    private function _searchForConflict(PHP_CodeSniffer_File $phpcsFile, $start, $end, $tokens)
    {
        ...
        for ($i = $start; $i <= $end; $i++) {
            ...
            // Ignore 'declare' statements
            if ($this->excludeDeclare === true
